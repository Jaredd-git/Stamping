...
class ProductoQueries
{
    ...
    */
    ...
    {
        $sql = 'SELECT id_producto, nombre_producto, descripcion_producto, precio_producto, estado_producto, color_producto, id_tipo, id_talla_p, existencias
        FROM productos INNER JOIN tipos USING(id_tipo)
    ...
    public function updateRow()
    {
        $sql = 'UPDATE productos
                SET nombre_producto = ?, descripcion_producto = ?, precio_producto = ?, estado_producto = ?, color_producto = ?, id_tipo = ?, id_talla_p = ?, existencias = ?
                WHERE id_producto = ?';
