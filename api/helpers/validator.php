...
class Validator
{
    // Propiedades para manejar validaciones.
    ...
    */
    ...
    /*
    *   Método para limpiar todos los campos de un formulario (quitar los espacios en blanco al principio y al final.
    */
    ...
    *   Retorno: booleano (true si el valor es correcto o false en caso contrario).
    */
    public static function validateExist($value)
    {
        // Se verifica que el valor sea un número entero mayor o igual a uno.
