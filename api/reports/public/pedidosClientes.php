...
if ($dataPedido = $pedido->readAllPedido()) {
    ...
    $pdf->cell(20, 10, 'N° Pedido', 1, 0, 'C', 1);
    ...
    foreach ($dataPedido as $rowPedido) {
        ...
        $pdf->cell(20, 10, $pdf->encodeString($rowPedido['id_pedido']), 1, 0);
        $pdf->cell(60, 10, $rowPedido['cliente'], 1, 0);
        $pdf->cell(20, 10, $rowPedido['estado'], 1, 0);
        $pdf->cell(40, 10, $rowPedido['fecha_pedido'], 1, 0);
        $pdf->cell(46, 10, $rowPedido['direccion_pedido'], 1, 1);
    }
    }else {
